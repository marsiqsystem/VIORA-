...
<ShopPicks
  ...
  slugs="crimson-royale-ruby-necklace-set, emerald-bloom-ensemble-jewelry-set-pink"
  heading="Necklace sets for a lehenga"
  intro="Anchor pieces with enough weight for a lehenga, without competing with the blouse."
/>
