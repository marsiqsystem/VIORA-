...
<ShopPicks
  collection="gifting"
  maxPrice="500"
  heading="Gifts under ₹500, in stock right now"
  intro="Filtered live — anything sold out is hidden automatically."
/>
...
<ShopPicks
  collection="gifting"
  heading="A little over ₹500 — worth the stretch"
  intro="If the budget can flex slightly, these are the pieces we'd send."
/>
